let process = {
  ...
  aud1:function(){
	...
	page1:function(){
        ...
        <div className="progressbar-infinite color-multi"></div>
				<img src='img/circle.png' width='1000px'/><br/>  
        <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div> 
        <br/>
				<br/>
	...
	page2:function(){
        ...
        <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
				<img src='img/heart.png' width='1000px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
				<br/>
	...
	page3:function(){
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/diamond.JPG' width='1000px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
	...
	page4:function(){
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/hexagon.jpg' width='1000px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
    ...
    let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/octagon.gif' width='800px'/><br/>   
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page6:function(){
    let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/oval.JPG' width='1000px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page7:function(){
    let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/pentagon.JPG' width='1000px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page8:function(){
      let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/rectangle.JPG' width='1000px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page9:function(){
      let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/square.JPG' width='1000px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page10:function(){
      let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/star.png' width='1000px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
  ...
  page11:function(){
      let content = <div>
        ...
        <br/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <img src='img/triangle.JPG' width='1000px'/>
           <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
        <br/>
        <br/>
	...
	loading:function(){
        ...
        <div className="progressbar-infinite color-multi"></div>
					<div align='center'>
						<img src='img/front.JPG' width='1100px'/>
            <div className="progressbar-infinite color-multi"></div>
               <div className="progressbar-infinite color-multi"></div>
        <div className="progressbar-infinite color-multi"></div>
					</div>;
